...
import net.antnz.mysteriousmod.item.ModArmorMaterials;
...
public class MysteriousArmorItem extends ArmorItem {
    ...
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.MYSTERIOUS_ARMOR_MATERIALS,
                            List.of(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 100, 1, false, false),
                                    new StatusEffectInstance(StatusEffects.INVISIBILITY, 100, 1, false, false),
                                    new StatusEffectInstance(StatusEffects.GLOWING, 100, 1, false, false))).build();
